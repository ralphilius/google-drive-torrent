...
const DRIVE_CLIENT_ID = process.env.DRIVE_CLIENT_ID || driveCredentials.clientId;
const DRIVE_CLIENT_SECRET = process.env.DRIVE_CLIENT_SECRET|| driveCredentials.clientSecret;
